...
const goFreshReadyToGo = [
  {
    id: 1,
    name: "GoFresh Pineapple",
    description: "Savor the tropical vibes with GoFresh_Pineapple. This ready-to-drink pineapple delight captures the sweet and tangy essence of pineapples, making it a refreshing choice for any occasion. .",
  ...
  },
  {
    id: 2,
    name: "GoFresh Guava",
    description: "Experience the exotic allure of guava with GoFresh_Guava. This ready-to-drink delight packs the luscious flavor of guava into a portable bottle, ensuring you can savor its tropical goodness anytime, anywhere. ",
  ...
  },
  {
    id: 3,
    name: "GoFresh Orange",
    description: "Delicious mixed fruit blend in convenient packaging.",
  ...
  },
  {
    ...
    description: "T Enjoy a fusion of flavors with GoFresh_Mixed. This ready-to-drink delight combines an assortment of fruits into a single, convenient bottle, making it the perfect choice for those who appreciate variety.",
...
export default function GoFreshReadyToGo() {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={titleVariants} className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">
            Convenient ready-to-drink beverages perfect for busy lifestyles and on-the-go refreshment.
          </motion.p>
        </motion.div>
        ...
        >
          {goFreshReadyToGo.map((product, index) => (
            <motion.div
              key={product.id}
        ...
        {/* Enhanced bottom button */}
          ...
          <Link href="/goFreshReadyProducts">
            <motion.div
