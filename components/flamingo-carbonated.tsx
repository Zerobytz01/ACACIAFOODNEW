...
const flamingoCarbonated = [
  {
    id: 1,
    name: "Flamingo Havana",
    description: "Elevate any occasion with these vivacious refreshments that bring a burst of brightness to your table. Whoever believes that a carbonated drink couldn't ignite your senses hasn't experienced our Acacia's Flamingo Havana Cola Carbonated drink.",
  ...
  },
  {
    ...
    description: "Beyond its irresistibly delicious taste, it serves as a potent treasure trove of nutritional benefits. Pineapples, in addition to their delightful flavor, are nature's secret to maintaining radiant skin, providing a natural defense against the scorching heat.",
  ...
  },
  {
    ...
    description: "Orange juice not only aids in digestion but also enhances overall immunity. Our tango Orange captures the essence of this fruit, delivering a taste so enticing that you'll find yourself reaching for more than just one bottle.",
  ...
  },
  {
    ...
    description: " Ginger is not only readily available but can also be stored with ease, and its distinct flavor is as beloved as the root itself. Ginger juice not only aids in digestion but also enhances overall immunity. Our Ginger infusion brings out the finest taste.",
...
export default function FlamingoCarbonated() {
    ...
    <section className="py-8 md:py-16 lg:py-24 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Flamingo Carbonated Drinks
          </motion.h2>
          <motion.p variants={titleVariants} className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">
            Sparkling beverages with vibrant flavors and refreshing carbonation for the perfect fizz.
          </motion.p>
        </motion.div>
        ...
        >
          {flamingoCarbonated.map((product, index) => (
            <motion.div
              key={product.id}
        ...
        {/* Enhanced bottom button */}
          ...
          <Link href="/flamingoCarbonatedProducts">
            <motion.div
