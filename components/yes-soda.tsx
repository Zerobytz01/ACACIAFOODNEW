...
const yesSoda = [
  {
    id: 1,
    name: "Yes Apple",
    description: "YESS Apple - Tired of the clichéd saying 'an apple a day keeps the doctor away'? It's time to break free from the ordinary and embrace the latest trends in soda varieties with YESS Apple Soda. ",
  ...
  {
    id: 2,
    name: "Yes Soda_Energy_700x700.png",
    description: "YESS Energy - Your ultimate source of power and vitality, YESS Energy is the ideal drink for all your energy requirements. This invigorating beverage enhances both body and mind, sharpening focus, alertness",
  ...
  },
  {
    id: 3,
    name: "Yess Soda Cola",
    description: "YESS Cola - Immerse yourself in the refined flavor of caramel, as it unleashes the fizzy delight of every sip of Iron Brew.Whoever claimed that juice couldn't awaken your senses hasn't experienced Acacia's Iron",
  ...
  {
    id: 4,
    name: "Yes Soda Orange",
    description: "YESS Orange - Beyond its delightful sweet and tangy flavor, the health benefits of oranges make them a top choice. Packed with Vitamin C and fiber, oranges are a nutritional powerhouse.",
...
export default function YesSoda() {
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p variants={titleVariants} className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">
            Premium soda collection with classic flavors and modern refreshment for every occasion.
          </motion.p>
        </motion.div>
        ...
        {/* Enhanced bottom button */}
                  ...
                  <Link href="/yesSodaProducts" className="block">
                    <motion.div
